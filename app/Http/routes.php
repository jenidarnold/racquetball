...
Route::get('/scores/{user_id}/complete',  array('as' => 'scores.complete', 'uses' => 'Tools\RefereeController@complete'));
...
Route::group(['namespace' => 'Tools', 'prefix' =>'tools'], function()
{
	...
	Route::delete('league/{league_id}/player/{player_id}/destroy', array('as' => 'tools.league.player.delete', 'uses' => 'LeagueController@destroyPlayer'));
